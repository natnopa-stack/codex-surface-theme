...
- 两张脱敏 GIF 直接用于 GitHub README：外观控件演示与项目右键样式菜单。
...
Codex 更新后如果主题没有加载，请完全退出更新器启动的 Codex，再从 `LAUNCH-CODEX-THEMED.cmd` 启动。

完整安装、兼容性、安全边界与动态预览请参阅仓库 README 和 `docs` 目录。

本版本采用 MIT License 发布。
